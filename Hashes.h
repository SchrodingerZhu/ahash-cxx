...
//----------
// These are _not_ hash functions (even though people tend to use crc32 as
// one...)

static inline bool
BadHash_bad_seeds (std::vector<uint32_t> &seeds)
{
...
static inline bool
sumhash_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ UINT32_C (0) };
  return true;
}
...
static inline bool
crc32c_bad_seeds (std::vector<uint32_t> &seeds)
{
...
// This falls into a MSVC CL 14.16.27023 32bit compiler bug. 14.28.29910 works
// fine.
...
#  endif
#  if defined(__SSE4_2__) && (defined(__i686__) || defined(__x86_64__))       \
      && !defined(_MSC_VER)
void crc32c_hw1_test (const void *key, int len, uint32_t seed, void *out);
#  endif
static inline bool
crc64c_bad_seeds (std::vector<uint64_t> &seeds)
{
...
extern "C" uint32_t crc32_pclmul_le_16 (unsigned char const *buffer,
                                        size_t len, uint32_t crc32);
void crc32c_pclmul_test (const void *key, int len, uint32_t seed, void *out);
static inline bool
crc32c_pclmul_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ UINT32_C (0) };
  return true;
}
static inline bool
need_minlen64_align16 (pfHash hash)
{
...
static inline bool
FNV32a_YT_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ UINT32_C (0x811c9dc5) };
  return true;
}
inline void
FNV32a_YT_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
FNV1A_Totenschiff_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
FNV1A_PY_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
FNV128_test (const void *key, int len, uint32_t seed, void *out)
{
...
static inline bool
fletcher_bad_seeds (std::vector<uint64_t> &seeds)
{
  seeds = std::vector<uint64_t>{ UINT64_C (0) };
  return true;
}
...
inline void
fletcher2_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint64_t *)out = fletcher2 ((const char *)key, len, (uint64_t)seed);
}
uint64_t fletcher4 (const char *key, int len, uint64_t seed);
inline void
fletcher4_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint64_t *)out = fletcher2 ((const char *)key, len, (uint64_t)seed);
}
uint32_t Bernstein (const char *key, int len, uint32_t seed);
static inline bool
Bernstein_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ UINT32_C (0) };
  return true;
}
inline void
Bernstein_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out = Bernstein ((const char *)key, len, seed);
}
uint32_t sdbm (const char *key, int len, uint32_t hash);
static inline bool
sdbm_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ UINT32_C (0) };
  return true;
}
inline void
sdbm_test (const void *key, int len, uint32_t seed, void *out)
{
...
void CityHash64noSeed_test (const void *key, int len, uint32_t seed,
                            void *out);
void CityHash64_test (const void *key, int len, uint32_t seed, void *out);
inline void
CityHash64_low_test (const void *key, int len, uint32_t seed, void *out)
{
  uint64_t result;
...
void FarmHash64noSeed_test (const void *key, int len, uint32_t seed,
                            void *out);
...
inline void
MurmurHash1_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out = MurmurHash1 (key, len, seed);
}

inline void
MurmurHash2_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out = MurmurHash2 (key, len, seed);
}

inline void
MurmurHash2A_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out = MurmurHash2A (key, len, seed);
}

inline void
ahashcxx (const void *key, int len, uint32_t seed, void *out)
{
...
static void
MurmurHash64B_seed_init (uint32_t &seed)
{
  if ((seed & 0x10) == 0x10)
    seed++;
}
inline void
MurmurHash64B_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
jodyhash32_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out = jody_block_hash32 ((const jodyhash32_t *)key,
                                        (jodyhash32_t)seed, (size_t)len);
}
#ifdef HAVE_INT64
inline void
jodyhash64_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint64_t *)out = jody_block_hash ((const jodyhash_t *)key,
                                      (jodyhash_t)seed, (size_t)len);
}
#endif

inline void
xxHash32_test (const void *key, int len, uint32_t seed, void *out)
{
...
#ifdef HAVE_INT64
inline void
xxHash64_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 630-7fc + c10-1213: 1999
  *(uint64_t *)out
      = (uint64_t)XXH64 (key, (size_t)len, (unsigned long long)seed);
}
#endif
...
#ifdef HAVE_INT64
static inline bool
xxh3_bad_seeds (std::vector<uint64_t> &seeds)
{
  return false;
}
inline void
xxh3_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
xxh3low_test (const void *key, int len, uint32_t seed, void *out)
{
...
#ifdef HAVE_INT64
inline void
xxh128_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
xxh128low_test (const void *key, int len, uint32_t seed, void *out)
{
...
#  ifdef HAVE_INT64
inline void
metrohash64_test (const void *key, int len, uint32_t seed, void *out)
{
  MetroHash64::Hash ((const uint8_t *)key, (uint64_t)len, (uint8_t *)out,
                     seed);
}
inline void
metrohash64_1_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash64_1 ((const uint8_t *)key, (uint64_t)len, seed, (uint8_t *)out);
}
inline void
metrohash64_2_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash64_2 ((const uint8_t *)key, (uint64_t)len, seed, (uint8_t *)out);
}
inline void
metrohash128_test (const void *key, int len, uint32_t seed, void *out)
{
  MetroHash128::Hash ((const uint8_t *)key, (uint64_t)len, (uint8_t *)out,
                      seed);
}
inline void
metrohash128_1_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash128_1 ((const uint8_t *)key, (uint64_t)len, seed, (uint8_t *)out);
}
inline void
metrohash128_2_test (const void *key, int len, uint32_t seed, void *out)
{
...
#  if defined(HAVE_SSE42) && (defined(__x86_64__) || defined(__aarch64__))    \
      && !defined(_MSC_VER)
inline void
metrohash64crc_1_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash64crc_1 ((const uint8_t *)key, (uint64_t)len, seed, (uint8_t *)out);
}
inline void
metrohash64crc_2_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash64crc_2 ((const uint8_t *)key, (uint64_t)len, seed, (uint8_t *)out);
}
inline void
metrohash128crc_1_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash128crc_1 ((const uint8_t *)key, (uint64_t)len, seed,
                     (uint8_t *)out);
}
inline void
metrohash128crc_2_test (const void *key, int len, uint32_t seed, void *out)
{
  metrohash128crc_2 ((const uint8_t *)key, (uint64_t)len, seed,
                     (uint8_t *)out);
}
#  endif
inline void
cmetrohash64_1_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-28c: 652
  cmetrohash64_1 ((const uint8_t *)key, (uint64_t)len, seed, (uint8_t *)out);
}
inline void
cmetrohash64_1_optshort_test (const void *key, int len, uint32_t seed,
                              void *out)
{
  // objsize 0-db2: 3506
  cmetrohash64_1_optshort ((const uint8_t *)key, (uint64_t)len, seed,
                           (uint8_t *)out);
}
inline void
cmetrohash64_2_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 290-51f: 655
...
inline void
fasthash32_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out = fasthash32 (key, (size_t)len, seed);
}
#ifdef HAVE_INT64
inline void
fasthash64_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
ahash64_test (const void *key, int len, uint32_t seed, void *out)
{
...
static inline bool
mum_hash_bad_seeds (std::vector<uint64_t> &seeds)
{
  seeds = std::vector<uint64_t>{ UINT64_C (0) };
  return true;
}
...
inline void
mum_low_test (const void *key, int len, uint32_t seed, void *out)
{
  uint64_t result;
...
inline void
t1ha2_atonce_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-21d: 541
...
inline void
t1ha2_stream_test (const void *key, int len, uint32_t seed, void *out)
{
  t1ha_context_t ctx;
...
inline void
t1ha2_atonce128_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize b50-db5: 613
...
inline void
t1ha2_stream128_test (const void *key, int len, uint32_t seed, void *out)
{
  t1ha_context_t ctx;
...
inline void
t1ha1_64le_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-205: 517
...
inline void
t1ha1_64be_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 280-4ab: 555
...
inline void
t1ha0_32le_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-1fd: 509
...
inline void
t1ha0_32be_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 250-465: 533
...
#  ifndef _MSC_VER
inline void
t1ha0_ia32aes_noavx_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-39d: 925
...
#  if defined(__AVX__)
inline void
t1ha0_ia32aes_avx1_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-34b: 843
...
#  if defined(__AVX2__)
inline void
t1ha0_ia32aes_avx2_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 0-318: 792
...
void halftime_hash_style64_test (const void *key, int len, uint32_t seed,
                                 void *out);
// 455e90 - 45682e: 2462
void halftime_hash_style128_test (const void *key, int len, uint32_t seed,
                                  void *out);
// 458840 - 45927e: 2622
void halftime_hash_style256_test (const void *key, int len, uint32_t seed,
                                  void *out);
// 457a60 - 45883e: 3550 (without AVX512 on Ryzen3)
void halftime_hash_style512_test (const void *key, int len, uint32_t seed,
                                  void *out);
...
inline void
tabulation_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
tabulation_32_test (const void *key, int len, uint32_t seed, void *out)
{
...
#  include "wyhash32.h"
inline void
wyhash32_test (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
wyhash_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint64_t *)out = wyhash (key, (uint64_t)len, (uint64_t)seed, _wyp);
}
// objsize: 40da00-40dbda: 474
inline void
wyhash32low (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out
      = 0xFFFFFFFF & wyhash (key, (uint64_t)len, (uint64_t)seed, _wyp);
}
#endif
...
// This is vulnerable to keys len>4 and key[len/2 -2]..[len/2 +2] being 0
// (binary keys).
inline void
o1hash_test (const void *key, int len, uint32_t seed, void *out)
{
...
#  include "mir-hash.h"
static inline bool
mirhash_bad_seeds (std::vector<uint64_t> &seeds)
{
...
inline void
mirhash_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 2950-2da8: 1112
  *(uint64_t *)out = mir_hash (key, (uint64_t)len, (uint64_t)seed);
}
static inline bool
mirhash32_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ 0x0, 0x5e74c778, 0xa521f17b, 0xe0ab70e3 };
  return true;
}
inline void
mirhash32low (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out
      = 0xFFFFFFFF & mir_hash (key, (uint64_t)len, (uint64_t)seed);
}
inline void
mirhashstrict_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize 2950-2da8: 1112
  *(uint64_t *)out = mir_hash_strict (key, (uint64_t)len, (uint64_t)seed);
}
static inline bool
mirhashstrict32low_bad_seeds (std::vector<uint32_t> &seeds)
{
  seeds = std::vector<uint32_t>{ 0x7fcc747f };
  return true;
}
inline void
mirhashstrict32low (const void *key, int len, uint32_t seed, void *out)
{
  *(uint32_t *)out
      = 0xFFFFFFFF & mir_hash_strict (key, (uint64_t)len, (uint64_t)seed);
}
static void
mirhash_seed_init (uint32_t &seed)
{
  // reject bad seeds
...
static void
mirhash32_seed_init (uint32_t &seed)
{
  // reject bad seeds
  std::vector<uint32_t> bad_seeds;
  mirhash32_bad_seeds (bad_seeds);
  while (std::find (bad_seeds.begin (), bad_seeds.end (), (uint32_t)seed)
         != bad_seeds.end ())
    seed++;
}
...
// objsize 0-207: 519
extern "C" uint64_t tsip (const unsigned char *seed, const unsigned char *m,
                          uint64_t len);

extern "C" uint64_t seahash (const char *key, int len, uint64_t seed);
// objsize 29b0-2d17: 871
inline void
seahash_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint64_t *)out = seahash ((const char *)key, len, (uint64_t)seed);
}
inline void
seahash32low (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
md5_128 (const void *key, int len, uint32_t seed, void *out)
{
  md5_context md5_ctx;
  md5_starts (&md5_ctx);
...
inline void
md5_32 (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
md5_64 (const void *key, int len, uint32_t seed, void *out)
{
  unsigned char hash[16];
  md5_context md5_ctx;
  md5_starts (&md5_ctx);
...
#include "sha1.h"
inline void
sha1_160 (const void *key, int len, uint32_t seed, void *out)
{
  SHA1_CTX context;
...
inline void
sha1_32 (const void *key, int len, uint32_t seed, void *out)
{
  SHA1_CTX context;
...
inline void
sha1_64 (const void *key, int len, uint32_t seed, void *out)
{
  SHA1_CTX context;
...
inline void
blake2b160_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
...
inline void
blake2b224_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
blake2b256_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
blake2b256_64 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
int blake2s_init (hash_state *md, unsigned long outlen,
                  const unsigned char *key, unsigned long keylen);
inline void
blake2s128_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
blake2s160_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
blake2s224_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
blake2s256_test (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
blake2s256_64 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
  unsigned char buf[32];
...
inline void
sha2_224 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
sha2_224_64 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
...
inline void
sha2_256 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
sha2_256_64 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  unsigned char buf[32];
  hash_state ltc_state;
...
inline void
rmd128 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
rmd160 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
inline void
rmd256 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
...
// Keccak:
inline void
sha3_256_64 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  unsigned char buf[32];
  hash_state ltc_state;
...
inline void
sha3_256 (const void *key, int len, uint32_t seed, void *out)
{
  // objsize
  hash_state ltc_state;
  sha3_256_init (&ltc_state);
...
inline void
wysha (const void *key, int len, unsigned seed, void *out)
{
  uint64_t s[4]
      = { wyhash (key, len, seed + 0, _wyp), wyhash (key, len, seed + 1, _wyp),
          wyhash (key, len, seed + 2, _wyp),
          wyhash (key, len, seed + 3, _wyp) };
  memcpy (out, s, 32);
}
#endif
...
inline void
MeowHash128_test (const void *key, int len, unsigned seed, void *out)
{
...
inline void
MeowHash64_test (const void *key, int len, unsigned seed, void *out)
{
  *(int unsigned *)MeowDefaultSeed = seed;
  meow_u128 h = MeowHash (MeowDefaultSeed, (meow_umm)len, (void *)key);
...
inline void
MeowHash32_test (const void *key, int len, unsigned seed, void *out)
{
  *(int unsigned *)MeowDefaultSeed = seed;
  meow_u128 h = MeowHash (MeowDefaultSeed, (meow_umm)len, (void *)key);
...
extern "C" void sha1_process_x86 (uint32_t *state, const uint8_t *data,
                                  uint32_t length);
extern "C" void sha256_process_x86 (uint32_t *state, const uint8_t *data,
                                    uint32_t length);

// Note: improved native SHA functions with seed.
// These functions need to be padded to 64byte blocks, so its trivial to create
// max 64 collisions for each key.
inline void
sha1ni (const void *key, int len, uint32_t seed, void *out)
{
...
// Note: improved native SHA functions with seed and len encoded into the seed,
// to prevent Zeroes. These functions need to be padded to 64byte blocks, so it
// would be trivial to create max 64 collisions for each key.
inline void
sha1ni_32 (const void *key, int len, uint32_t seed, void *out)
{
  uint32_t state[5]
      = { 0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476, 0xc3d2e1f0 };
  state[0] ^= seed;
...
inline void
sha2ni_256 (const void *key, int len, uint32_t seed, void *out)
{
...
inline void
sha2ni_256_64 (const void *key, int len, uint32_t seed, void *out)
{
  uint32_t state[8] = { 0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a,
                        0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19 };
  state[0] ^= seed;
...
#include "blake3/blake3_impl.h"
  // The C API, serially
  inline void
  blake3c_test (const void *key, int len, unsigned seed, void *out)
  {
    ...
    uint32_t seed_key[8]
        = { 0x6A09E667 ^ (uint32_t)seed,
            ...
            0x9B05688C,
            0x1F83D9AB,
            0x5BE0CD19 }; // Copied the default IV from blake3_impl.h
    blake3_hasher_init_keyed (
        &hasher, (uint8_t *)seed_key); // Changed to the KEYED variant
#endif
...
inline void
blake3_test (const void *key, int len, unsigned seed, void *out)
{
  rs_arr input;
  rs_arr *result;
  input.ptr = (char *)key;
...
inline void
blake3_64 (const void *key, int len, unsigned seed, void *out)
{
  rs_arr input;
  rs_arr *result;
  input.ptr = (char *)key;
...
inline void
aesnihash_test (const void *key, int len, unsigned seed, void *out)
{
  uint64_t result
      = aesnihash ((uint8_t *)key, (unsigned long)len, (uint32_t)seed);
  *(uint64_t *)out = result;
}
#endif
...
inline void
prvhash64_64mtest (const void *key, int len, unsigned seed, void *out)
{
  *(uint64_t *)out = prvhash64_64m ((const uint8_t *)key, len, (uint64_t)seed);
}
// objsize: 411b40 - 411cc0: 384
inline void
prvhash64_64test (const void *key, int len, unsigned seed, void *out)
{
  uint8_t hash[16] = { 0 };
...
inline void
prvhash64_128test (const void *key, int len, unsigned seed, void *out)
{
  uint8_t hash[32] = { 0 };
...
inline void
prvhash64s_64test (const void *key, int len, unsigned seed, void *out)
{
  // if seedless: prvhash64s_oneshot(key, len, out, 8);
  PRVHASH64S_CTX ctx;
  uint64_t SeedXOR[PRVHASH64S_PAR]
      = { (uint64_t)seed, (uint64_t)seed, (uint64_t)seed, (uint64_t)seed };
...
inline void
prvhash64s_128test (const void *key, int len, unsigned seed, void *out)
{
  PRVHASH64S_CTX ctx;
  uint64_t SeedXOR[PRVHASH64S_PAR]
      = { (uint64_t)seed, (uint64_t)seed, (uint64_t)seed, (uint64_t)seed };
...
inline void
komihash_test (const void *key, int len, unsigned seed, void *out)
{
...
#include "mx3/mx3.h"
inline void
mx3hash64_test (const void *key, int len, uint32_t seed, void *out)
{
  *(uint64_t *)out
      = mx3::hash ((const uint8_t *)(key), (size_t)len, (uint64_t)seed);
}
...
inline void
pengyhash_test (const void *key, int len, uint32_t seed, void *out)
{
...
#  include "pearson_hash/pearsonb.h"
  ...
  inline void
  pearsonb64_test (const void *key, int len, uint32_t seed, void *out)
  {
    *(uint64_t *)out
        = pearsonb_hash_64 ((const uint8_t *)key, (size_t)len, (uint64_t)seed);
  }
  // objsize: 41a1f0-41a65e: 1134
  inline void
  pearsonb128_test (const void *key, int len, uint32_t seed, void *out)
  {
  ...
  // 41a660-41a9ac: 844
  inline void
  pearsonb256_test (const void *key, int len, uint32_t seed, void *out)
  {
...
#    include "pearson_hash/pearson.h"
  inline void
  pearson64_test (const void *key, int len, uint32_t seed, void *out)
  {
    *(uint64_t *)out
        = pearson_hash_64 ((const uint8_t *)key, (size_t)len, seed);
  }
  inline void
  pearson128_test (const void *key, int len, uint32_t seed, void *out)
  {
    pearson_hash_128 ((uint8_t *)out, (const uint8_t *)key, (size_t)len);
  }
  inline void
  pearson256_test (const void *key, int len, uint32_t seed, void *out)
  {
...
#    include "khash.h"
  ...
  inline void
  khash32_test (const void *key, int len, uint32_t seed, void *out)
  {
    uint32_t hash = ~seed;
  ...
  inline void
  khash64_test (const void *key, int len, uint32_t seed, void *out)
  {
